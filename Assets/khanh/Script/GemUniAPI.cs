...
public class GemUniAPI : MonoBehaviour
{
   ...
   public void CallGemUniAPI()
    ...
    public void CallOnLimitScore()
    {
        if (!isWebGL()) return;
        jsBindingGemUniAPIFromUnity();
        Debug.LogError("++++++++++Tencommit________________call on limit score");
    ...
    public void CallOnLimitScore(int score)
    {
        ...
        Debug.LogError("++++++++++Tencommit________________call on limit score: " + score);
    ...
    public void CallRequestSubmit()
    {
        if (!isWebGL()) return;
        jsBindingRequestSubmitFromUnity();
        Debug.LogError("++++++++++Tencommit________________call Request Submit");
